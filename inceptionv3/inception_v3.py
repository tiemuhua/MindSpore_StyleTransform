...
after 6e
        if self.is_training:
            ...
            aux_logits = None
'''
def loaded_InceptionV3():
    net=InceptionV3(num_classes=1000,is_training=False)
    from mindspore.train.serialization import load_checkpoint, load_param_into_net
    param_dict = load_checkpoint("/home/wks/mindspore/model_zoo/official/cv/inceptionv3/ckpt_0/inceptionv3-rank0-2_10009.ckpt")
