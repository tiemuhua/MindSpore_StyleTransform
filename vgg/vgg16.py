...
class Vgg(nn.Cell):
    ...
    def __init__(self, base, num_classes=1000, batch_norm=False, batch_size=1, args=None, phase="test",
                 include_top=True):
...
cfg = {
    ...
    '16_conv1':[64, 64,],
    '16_conv2':[64, 64,'M', 128, 128],
    '16_conv3':[64, 64,'M', 128, 128,'M', 256, 256, 256],
    '16_conv4':[64, 64,'M', 128, 128,'M', 256, 256, 256,'M', 512, 512, 512]
}


def vgg(endpoint, num_classes=1000,  args=None, phase="test"):
    """
    ...
    """ 
    param_dict = load_checkpoint("/root/xl/lab/vgg/vgg16.ckpt")
    if args is None:
        
        args = config.cifar_cfg 
    net = Vgg(cfg[endpoint], num_classes=num_classes, args=args, batch_norm=args.batch_norm, phase=phase)
...
class Vgg16(nn.Cell):
    def __init__(self):
        ...
        self.layer1=vgg('16_conv1') 
        self.layer2=vgg('16_conv2')
        self.layer3=vgg('16_conv3')
        self.layer4=vgg('16_conv4')
    def construct(self,x):
